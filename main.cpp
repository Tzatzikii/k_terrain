...
private:
    ...
    void setupDebugMessenger() {
        ...
        if( CreateDebugUtilsMessengerEXT( instance, &createInfo, nullptr, &debugMessenger ) != VK_SUCCESS ) {
            throw std::runtime_error( "falied to set up debug messeger!" );
        }
    ...
    void createDescriptorSets() {
        ...
        for( size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++ ) {
            ...
            vkUpdateDescriptorSets( device, static_cast<uint32_t>( descriptorSets.size() ), descriptorWrites.data(), 0, nullptr );
    ...
    void createBuffer( VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties,
        ...
        void createImage( uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits sampleCount, VkFormat format, VkImageTiling tiling,
        ...
        void createTextureImage() {
            ...
            createImage( texWidth, texHeight, this->mipLevels, VK_SAMPLE_COUNT_1_BIT, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL,
                VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT ,
        ...
        void createTextureImageView() {
            textureImageView = createImageView( textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, this->mipLevels );
        }

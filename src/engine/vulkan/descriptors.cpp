...
void BaseApp::create_descriptor_pool() {
    ...
    pool_sizes[1].descriptorCount   = static_cast<uint32_t>( MAX_FRAMES_IN_FLIGHT * chunk_tree->get_tree_size() );
...
void BaseApp::create_descriptor_sets() {
    ...
    for( size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++ ) {
        ...
        std::vector<vk::DescriptorImageInfo> noise_images( chunk_tree->get_tree_size() );
